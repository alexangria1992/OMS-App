                    ...
                    <form action="" class="shadow-lg p-4" method="POST">
                        <div class="form-group">
                            <i class="fas fa-user"></i><label class="font-weight-bold">Email</label>
                             <input class="form-control" placeholder="Email" name="aEmail" type="email">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" placeholder="Password" name="aPassword" type="password">
                        </div>
